...
export default class Frame extends Component {
  // Preact warns when you render directly into the body since browser extensions
  // also inject into the body and can mess up Preact. For this reason
  // initialContent is expected to have a div inside of the body
  // element that we render preact into.
  static propTypes = {
  ...
  renderFrameContents() {
    ...
    // return [
    //   PreactDOM.createPortal(this.props.head, this.getDoc().head),
    //   PreactDOM.createPortal(contents, mountTarget)
    // ];
    return [
      <Preact.Fragment>
        <Portal into={this.getDoc().head}>{this.props.head}</Portal>
        <Portal into={mountTarget}>{contents}</Portal>
      </Preact.Fragment>
    ];
  }
